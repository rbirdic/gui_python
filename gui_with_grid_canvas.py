...
btn1 = tk.Button(text='Espresso', compound=tk.LEFT, image=photo1, font=helv36, borderwidth=10, command=callback1)
...
volumeUp = tk.Button(height=2, width=10, text='◄◄', borderwidth=10, fg = 'black', bg='light blue').grid(row=0,column=0)
volumeDown =tk.Button(height=2, width=10, text='►', borderwidth=10, fg = 'black', bg='light blue').grid(row=0,column=1)
